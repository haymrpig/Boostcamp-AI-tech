...
![image-20220216220145161](../../../../AppData/Roaming/Typora/typora-user-images/image-20220216220145161.png)
...
![image-20220216215942314](../../../../AppData/Roaming/Typora/typora-user-images/image-20220216215942314.png)
...
- **Step1. mlflow설치하기**
  ...
  ![image-20220216204452230](../../../../AppData/Roaming/Typora/typora-user-images/image-20220216204452230.png)
...
- **Step2. Experiment 생성**
  ...
  ![image-20220216204641762](../../../../AppData/Roaming/Typora/typora-user-images/image-20220216204641762.png)

  ls 명령어를 치면 mlruns라는 디렉토리가 생기고 실험에 대한 것을 저장한다.

  ![image-20220216204829935](../../../../AppData/Roaming/Typora/typora-user-images/image-20220216204829935.png)
  ...
  ![image-20220216204948711](../../../../AppData/Roaming/Typora/typora-user-images/image-20220216204948711.png)

- **Step3. 폴더를 생성한 후, 머신러닝 코드 생성**

  logistic_regression 디렉토리 생성 후, training code를 작성한다. 

  ![image-20220216205919069](../../../../AppData/Roaming/Typora/typora-user-images/image-20220216205919069.png)

  기존 코드에 저 두줄의 코드를 추가하면 완성!!

  > 원래는 auto log 대신 조금 복잡하게 써야한다. 
  >
  > auto log는 pytorch.nn.Module은 지원하지 않으므로 직접 명시해야 함![image-20220216212224596](../../../../AppData/Roaming/Typora/typora-user-images/image-20220216212224596.png)
...
- **Step4. MLProject 만들기**
  ...
  **파일 이름은 무조건 MLProject로 만들어야 한다!!!!!**
  ...
  ![image-20220216210233210](../../../../AppData/Roaming/Typora/typora-user-images/image-20220216210233210.png)
...
- **Step5. Run하기**
  ...
  ![image-20220216211905189](../../../../AppData/Roaming/Typora/typora-user-images/image-20220216211905189.png)
...
- **Step6. UI 실행하기**
  ...
  ![image-20220216211032692](../../../../AppData/Roaming/Typora/typora-user-images/image-20220216211032692.png)

  위 링크를 들어가면 아래 사진과 같은 UI가 생성되어 있다!

  ![image-20220216211446513](../../../../AppData/Roaming/Typora/typora-user-images/image-20220216211446513.png)

  위의 빨간색 부분으로 칠한 RUN정보를 클릭해보자.

  ![image-20220216211519027](../../../../AppData/Roaming/Typora/typora-user-images/image-20220216211519027.png)
...
- **파라미터를 직접 입력하고 싶을 경우**
  ...
  ![image-20220216212919104](../../../../AppData/Roaming/Typora/typora-user-images/image-20220216212919104.png)

  ![image-20220216213120268](../../../../AppData/Roaming/Typora/typora-user-images/image-20220216213120268.png)

  ![image-20220216212730740](../../../../AppData/Roaming/Typora/typora-user-images/image-20220216212730740.png)
...
- **Run한 내용을 tree 구조로 보여줌**
  ...
  ![image-20220216213936488](../../../../AppData/Roaming/Typora/typora-user-images/image-20220216213936488.png)
